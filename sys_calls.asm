;Linux system call numbers for x86_64 (MASM syntax)
;Up to date list: https://github.com/torvalds/linux/blob/master/arch/x86/entry/syscalls/syscall_64.tbl
;More info: http://blog.rchapman.org/posts/Linux_System_Call_Table_for_x86_64/
